...
import { User, Shield, Edit, Save, Key, Bell, Clock, Activity } from 'lucide-react';
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: 16 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <GlassCard className="card" style={{ padding: '16px 18px' }}>
            ...
            <button className="btn btn-secondary" style={{ width: '100%', marginTop: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, fontSize: 11 }}><Key size={12} />Change Password</button>
          </GlassCard>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <GlassCard className="card" style={{ padding: '16px 24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
              {[
                { label: 'Email Alerts', active: true }, { label: 'SMS Alerts', active: false },
                { label: 'Critical Only', active: false }, { label: 'Weekly Digest', active: true },
              ].map(pref => (
                <div key={pref.label} style={{ background: pref.active ? 'rgba(34,197,94,0.08)' : 'rgba(255,255,255,0.03)', border: `1px solid ${pref.active ? 'rgba(34,197,94,0.2)' : 'rgba(255,255,255,0.06)'}`, borderRadius: 8, padding: '10px 12px', textAlign: 'center' }}>
