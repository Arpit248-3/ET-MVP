          ...
          <div ref={userMenuRef} style={{ position: 'relative' }}>
            ...
            >
              ...
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--text-main)', lineHeight: 1.2 }}>{mockUser.name}</div>
                <div style={{ fontSize: 10, color: 'var(--text-dim)', lineHeight: 1.2 }}>{mockUser.role}</div>
              </div>
